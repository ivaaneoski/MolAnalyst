...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // Mocking the API response format
      // In reality we would hit /auth/login
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <Card className="w-full max-w-[420px] shadow-lg">
        <CardHeader className="text-center space-y-4 pb-4">
          ...
          <CardTitle>Sign in to MolAnalyst</CardTitle>
          <CardDescription>
            Access your analysis history and saved structures
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-end pt-1">
                  <a href="#" className="text-sm text-electric hover:underline underline-offset-4">Forgot password?</a>
                </div>
              </div>
        ...
        <CardFooter className="justify-center border-t border-slate-100 pt-6">
          <p className="text-sm text-slate-600">
            ...
            <Link to="/register" className="text-electric font-medium hover:underline underline-offset-4">Create one →</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
